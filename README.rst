...
- ``Database`` and ``Connection`` are context managers, and close cleanly on exit, even if an exception is raised.
- Fully type hinted (``py.typed``); type checkers like mypy can verify your usage of Records.
